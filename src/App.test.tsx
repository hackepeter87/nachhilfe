...
describe('App-Ablauf', () => {
  ...
  it('zeigt technische Versionen nur auf Abruf', async () => {
    ...
    expect(screen.getByText('nrw-klasse3-foerderkern 0.5.0')).not.toBeVisible()
    await user.click(screen.getByLabelText('Versionsinformationen öffnen'))
    expect(screen.getByText('nrw-klasse3-foerderkern 0.5.0')).toBeVisible()
    expect(screen.getByText('0.7.0')).toBeVisible()
