...
const EXPECTED_TYPES = {
  ...
  patterns: ['pattern-activate-find-block', 'pattern-understand-restart', 'pattern-guided-continue', 'pattern-independent-continue', 'pattern-automate-next-pair', 'pattern-transfer-number-sequence'],
