...
## Release-Stand 0.29.0

Version 0.29.0 migriert ebene Figuren, Muster, Fläche, Umfang, Symmetrie, Körperansichten, Würfelrotation und Falten auf sechs fachlich verschiedene Lernhandlungen. Die Wege beginnen mit Beobachten und Begründen, trennen Fläche von Randlänge und führen räumliche Transformationen kontrolliert bis zur Fehleranalyse. Katalog 0.28.0 bleibt bei Schema 19. Details stehen in [docs/didactic-migration-0.29.0.md](docs/didactic-migration-0.29.0.md) und [RELEASE_NOTES.md](RELEASE_NOTES.md). Eine externe Lehrkraftprüfung und ein echter iPhone-Test sind weiterhin nicht erfolgt.
