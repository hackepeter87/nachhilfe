...
## Release-Stand 0.20.1

Version 0.20.1 führt keine neue Kompetenz ein. Produktive Symmetrie verwendet ausschließlich gerade Achsendimensionen mit Achsen zwischen Rasterfeldern. Division unterscheidet vollständiges Gruppieren und Verteilen, und `scaffold`-Darstellungen erscheinen erst in der Remediation. Katalog 0.19.1 und Schema 17 bleiben zentral abgeglichen. Der repositoryweite Audit steht in [docs/representation-runtime-audit-0.20.1.md](docs/representation-runtime-audit-0.20.1.md). Eine externe Lehrkraftprüfung und ein echter iPhone-Test sind weiterhin nicht erfolgt. Details stehen außerdem in [docs/representation-policy.md](docs/representation-policy.md) und [RELEASE_NOTES.md](RELEASE_NOTES.md).
