...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.23.0
...
## Release-Stand 0.23.0

Version 0.23.0 führt keine neue Kompetenz ein. Addition, Subtraktion und Ergänzen bis 1000 folgen nun in allen sechs Lernphasen unterschiedlichen mathematischen Handlungen: Stellen und Richtung aktivieren, Zwischenziele verstehen, Teilschritte geführt ausführen, selbstständig rechnen, ohne Zeitdruck abrufen und Strategien beziehungsweise Umkehraufgaben übertragen. Katalog 0.22.0 bleibt bei Schema 18; Details stehen in [docs/didactic-migration-0.23.0.md](docs/didactic-migration-0.23.0.md) und [RELEASE_NOTES.md](RELEASE_NOTES.md). Eine externe Lehrkraftprüfung und ein echter iPhone-Test sind weiterhin nicht erfolgt.
