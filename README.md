...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.24.0
...
## Release-Stand 0.24.0

Version 0.24.0 führt keine neue Kompetenz ein. Runden auf Zehner und Hunderter folgt nun in allen sechs Lernphasen unterschiedlichen mathematischen Handlungen: Nachbarn aktivieren, Abstände und Halbpunkt verstehen, die Entscheidung geführt ausführen, selbstständig runden, ohne Zeitdruck abrufen und eine passende ungefähre Genauigkeit in einem Alltagsszenario wählen. Katalog 0.23.0 bleibt bei Schema 18; Details stehen in [docs/didactic-migration-0.24.0.md](docs/didactic-migration-0.24.0.md) und [RELEASE_NOTES.md](RELEASE_NOTES.md). Eine externe Lehrkraftprüfung und ein echter iPhone-Test sind weiterhin nicht erfolgt.
