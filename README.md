...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.32.4
...
## Entwicklungsstand 0.32.4

Version 0.32.4 führt keine neue Kompetenz ein. Sie ergänzt die Navigation auf Startseite, in laufenden Runden und im Abschluss, bestätigt das Verlassen einer Runde und ermöglicht das vollständige lokale Zurücksetzen von Profil, Einstellungen, Lernstand und Sitzungen. Die PWA-Installation und ihr Offline-Cache bleiben dabei erhalten. App 0.32.4 verwendet Katalog 0.31.2 bei unverändertem Schema 19. Details stehen im [Patchbericht](docs/release-0.32.4.md), im [GitHub Release](https://github.com/hackepeter87/nachhilfe/releases/tag/v0.32.4) und in den [Release Notes](RELEASE_NOTES.md).

Die familienweise manuelle Prüfung ist damit nicht abgeschlossen. Der aktuelle Stand setzt die konkret belegten Befunde und Lehrkraftbeispiele um, ist aber keine vollständige Abnahme aller Varianten. Die vorhandenen echten Gerätefotos belegen Ausgangsfehler; Version 0.32.4 wurde dort noch nicht vollständig abgenommen. Eine externe Lehrkraftprüfung und eine Unterrichtserprobung sind weiterhin nicht erfolgt.
