...
Die manuelle Erprobung von 0.30.0 hat trotz grüner technischer Prüfungen erhebliche Verständlichkeitsmängel aufgedeckt. Der [kritische Audit 0.30.1](docs/didactic-critical-audit-0.30.1.md) dokumentiert diese Befunde. Version 0.31.0 ergänzt deshalb einen [reproduzierbaren didaktischen Prüfstand](docs/didactic-review-workbench.md). Die [iPhone-Regressionskorrektur 0.31.1](docs/didactic-hotfix-0.31.1.md) beseitigt einen mehrdeutigen Symmetrie-Transfer, eine reine Abschreibaufgabe und eine instabile Strichlistendarstellung. Version 0.32.0 überführt die von einer Lehrkraft bereitgestellten Übungsformen in eigenständige digitale Lernhandlungen für Stellenwert, Zahlbeziehungen und Zehnerübergang; 0.32.1 stellt deren Erreichbarkeit in normalen Runden sicher. Der [Korrekturrelease 0.32.2](docs/release-0.32.2.md) behebt weitere konkrete iPhone-Befunde bei Aufgabenfamilien, Zahlenstrahlen, Zufall, Mustern und Bezugsgrößen. Automatisierte Konsistenz gilt nicht als Nachweis kindgerechter Didaktik.
...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.32.2
...
## Entwicklungsstand 0.32.2

Version 0.32.2 führt keine neue Kompetenz ein. Sie korrigiert die Darstellung von Aufgabenfamilien bis 20, trennt die beiden Divisionshandlungen sichtbar, maskiert Nachbargrenzen ohne doppelte Beschriftung, ersetzt abstrakte Zufallsformulierungen, hält Musterblöcke in einer Reihe und zeigt bei Bezugsgrößen ein konkretes Alltagsobjekt. App 0.32.2 verwendet Katalog 0.31.1 bei unverändertem Schema 19. Details stehen im [Patchbericht](docs/release-0.32.2.md) und in den [Release Notes](RELEASE_NOTES.md).

Die familienweise manuelle Prüfung ist damit nicht abgeschlossen. Der aktuelle Stand setzt die konkret belegten Befunde und Lehrkraftbeispiele um, ist aber keine vollständige Abnahme aller Varianten. Die vorhandenen echten iPhone-Screenshots belegen Ausgangsfehler; die korrigierte Version 0.32.2 wurde dort noch nicht erneut vollständig abgenommen. Eine externe Lehrkraftprüfung und eine Unterrichtserprobung sind weiterhin nicht erfolgt.
