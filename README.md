...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.32.0
...
## Entwicklungsstand 0.32.0

Version 0.32.0 führt keine neue Kompetenz ein. Stellenwertmaterial, H-Z-E-Tafel, Zahlzerlegung und Zahlwort werden als zusammenhängende Darstellungen genutzt. Transferaufgaben lassen Zahlen tatsächlich ordnen. Nachbaraufgaben verbinden Vorgänger, Nachfolger, Nachbarzehner und Nachbarhunderter; der Zahlenstrahl verwendet den passenden lokalen Ausschnitt. Addition und Subtraktion mit Zehnerübergang zerlegen den zweiten Operanden sichtbar und führen zuerst zum vollen Zehner. Geldaufgaben zeigen die für die Lösung benötigten Münzen beziehungsweise Preis- und Zahlbetrag in jeder Lernphase. App 0.32.0 verwendet Katalog 0.31.0 bei unverändertem Schema 19. Details stehen im [Korrekturbericht](docs/didactic-stabilization-0.32.0.md) und in den [Release Notes](RELEASE_NOTES.md).

Die familienweise manuelle Prüfung ist damit nicht abgeschlossen. Der aktuelle Stand setzt die konkret belegten Befunde und Lehrkraftbeispiele um, ist aber keine vollständige Abnahme aller Zahlen- und Modellierungsvarianten. Größen, Daten und Raum folgen in 0.33. Die vorhandenen echten iPhone-Screenshots belegen Ausgangsfehler; die korrigierte Version 0.32.0 wurde dort noch nicht erneut abgenommen. Eine externe Lehrkraftprüfung und eine Unterrichtserprobung sind weiterhin nicht erfolgt.
