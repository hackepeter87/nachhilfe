...
Die manuelle Erprobung von 0.30.0 hat trotz grüner technischer Prüfungen erhebliche Verständlichkeitsmängel aufgedeckt. Der [kritische Audit 0.30.1](docs/didactic-critical-audit-0.30.1.md) dokumentiert diese Befunde. Version 0.31.0 ergänzt deshalb einen [reproduzierbaren didaktischen Prüfstand](docs/didactic-review-workbench.md). Die [iPhone-Regressionskorrektur 0.31.1](docs/didactic-hotfix-0.31.1.md) beseitigt einen mehrdeutigen Symmetrie-Transfer, eine reine Abschreibaufgabe und eine instabile Strichlistendarstellung. Version 0.32.0 überführt die von einer Lehrkraft bereitgestellten Übungsformen in eigenständige digitale Lernhandlungen für Stellenwert, Zahlbeziehungen und Zehnerübergang; 0.32.1 stellt deren Erreichbarkeit in normalen Runden sicher. Der [Korrekturrelease 0.32.2](docs/release-0.32.2.md) behebt weitere konkrete iPhone-Befunde. Version 0.32.3 entfernt den fachlich nicht überzeugenden Bereich „Zufall einschätzen“ vollständig aus produktiven Runden. Version 0.32.4 ergänzt eine sichere Navigation und das bestätigte lokale Zurücksetzen. Version 0.32.5 speichert abgeschlossene Runden vor der Abschlussansicht und ersetzt die wirkungslose Pflichtabfrage durch klare nächste Aktionen. Automatisierte Konsistenz gilt nicht als Nachweis kindgerechter Didaktik.
...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.32.5
...
## Entwicklungsstand 0.32.5

Version 0.32.5 führt keine neue Kompetenz ein. Sie speichert eine abgeschlossene Runde unmittelbar nach der letzten Aufgabe, entfernt die nicht adaptiv ausgewertete Pflichtabfrage und bietet direkt eine neue Runde oder die Startseite an. Navigation und lokales Zurücksetzen aus 0.32.4 bleiben erhalten. App 0.32.5 verwendet Katalog 0.31.2 bei unverändertem Schema 19. Details stehen im [Patchbericht](docs/release-0.32.5.md), im [GitHub Release](https://github.com/hackepeter87/nachhilfe/releases/tag/v0.32.5) und in den [Release Notes](RELEASE_NOTES.md).

Die familienweise manuelle Prüfung ist damit nicht abgeschlossen. Der aktuelle Stand setzt die konkret belegten Befunde und Lehrkraftbeispiele um, ist aber keine vollständige Abnahme aller Varianten. Die vorhandenen echten Gerätefotos belegen Ausgangsfehler; Version 0.32.5 wurde dort noch nicht vollständig abgenommen. Eine externe Lehrkraftprüfung und eine Unterrichtserprobung sind weiterhin nicht erfolgt.
