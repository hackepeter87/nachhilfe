...
Der lokale, noch unveröffentlichte Arbeitsstand 0.32.6 führt keine neue Kompetenz ein. Er korrigiert Bezugspunkte auf Subtraktions-Rechenstrichen, geführte Nachbaraufgaben, Divisionsmodelle, mehrschrittige UI-Zustände, Zahlwortzerlegungen, Kombinatorik-Einstiege und kindliche Sachaufgabentexte. Stellenwert-Remediation bleibt beim Vergleichen und Ordnen; Wahrscheinlichkeit ist in allen Katalogphasen konsistent deaktiviert. App 0.32.6 verwendet Katalog 0.31.3 bei unverändertem Schema 19. Der zuletzt veröffentlichte Stand bleibt [0.32.5](docs/release-0.32.5.md) mit seinem [GitHub Release](https://github.com/hackepeter87/nachhilfe/releases/tag/v0.32.5).
