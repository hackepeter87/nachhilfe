...
```bash
podman pull ghcr.io/hackepeter87/nachhilfe:0.32.1
...
## Entwicklungsstand 0.32.1

Version 0.32.1 führt keine neue Kompetenz ein. Jede normale Runde enthält einen rotierenden Fokus aus den Lehrkraftbeispielen: Stellenwertmaterial, Zahlenvergleich und -ordnung, Zahlwort, Nachbarzehner, Nachbarhunderter, Zahlenfolge oder Zehnerübergang bei Addition beziehungsweise Subtraktion. Die übrigen Aufgaben bleiben adaptiv. Die Rotation wird aus der Zahl abgeschlossener Runden bestimmt und überlebt dadurch Reload und Browserneustart, ohne Lernstände zurückzusetzen. App 0.32.1 verwendet Katalog 0.31.0 bei unverändertem Schema 19. Details stehen im [Patchbericht](docs/release-0.32.1.md) und in den [Release Notes](RELEASE_NOTES.md).

Die familienweise manuelle Prüfung ist damit nicht abgeschlossen. Der aktuelle Stand setzt die konkret belegten Befunde und Lehrkraftbeispiele um, ist aber keine vollständige Abnahme aller Zahlen- und Modellierungsvarianten. Größen, Daten und Raum folgen in 0.33. Die vorhandenen echten iPhone-Screenshots belegen Ausgangsfehler; die korrigierte Version 0.32.1 wurde dort noch nicht erneut abgenommen. Eine externe Lehrkraftprüfung und eine Unterrichtserprobung sind weiterhin nicht erfolgt.
