...
Stand: App 0.32.3, Katalog 0.31.2, Schema 19. Dieses Dokument trennt automatisierte und interne Prüfungen von noch ausstehenden externen Abnahmen.
...
- Die automatisch erzeugte Curriculum-Matrix erfasst alle 33 aktiven Kompetenzen; der Integrationslauf erzeugt jede aktive Kompetenz auf allen drei Stufen über jeweils 1.000 Seeds.
- Die erste didaktische Korrekturgruppe prüft zusätzlich unterschiedliche Lernhandlungen je Phase, katalogisierte Fehlvorstellungsrouten, exakte Uhrzeigerwinkel, aktives Paaren, Mustertransfer und vollständigen UI-Zustandsreset.
- Geld und Längen sind seit 0.8 aktiv. Schriftliche Addition mit höchstens einem Übertrag ist seit 0.11 aktiv; schriftliche Subtraktion mit höchstens einer Entbündelung ist seit 0.12 aktiv. Körperansichten sind seit 0.13, kontrollierte 90-Grad-Würfelrotation seit 0.14, einzelne Faltungen samt einfachem Faltschnitt seit 0.15, Daten seit 0.16, Zeit/Masse/Rauminhalt seit 0.18 und ebene Geometrie seit 0.19 aktiv. Die in 0.17 eingeführte Aufgabenfamilie Wahrscheinlichkeit ist seit 0.32.3 wegen unzureichendem Förderwert deaktiviert; Kombinatorik bleibt aktiv. Mehrere gleichzeitige Übergänge, Millimeter/Kilometer, freie Rotation, Kippen, Mehrfachfaltungen und Körpernetze bleiben deaktiviert.
