...
Das lokale AMD64-Testimage trägt den Tag `mathe-reise:local`. Der Release ist über Git-Tag `v0.32.6`, den [GitHub Release](https://github.com/hackepeter87/nachhilfe/releases/tag/v0.32.6) und das AMD64-GHCR-Image `ghcr.io/hackepeter87/nachhilfe:0.32.6` veröffentlicht. Die zusätzlichen Tags `sha-a41f957` und `latest` zeigen auf denselben Digest `sha256:008865834189882cfccc3068117c8044d506d77925ed026e028f4e13357d803b`; die OCI-Revision ist `a41f957a14b84870dc57389d8a8cdeb78f61671f`. Ein erneuter Test dieses Arbeitsstands auf dem echten iPhone und eine externe Lehrkraftprüfung sind nicht erfolgt; WebKit bleibt lediglich eine Mobile-Safari-Näherung.
