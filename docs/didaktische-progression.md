...
Stand: Katalogversion 0.29.0. Die Stufen beschreiben die produktive Heuristik von Mathe-Reise. Sie sind keine Diagnose, Schulnote oder wissenschaftlich validierte Einstufung. Seit Schema 18 ist zusätzlich jede Lernphase an eine konkrete Lernhandlung und einen begrenzten Interaktionstyp gebunden; die Familienmigrationen 0.21.0 bis 0.29.0 und der abschließende [Konvergenz-Audit 0.30.0](didactic-convergence-audit-0.30.0.md) dokumentieren den gemeinsamen Standard. Das verbindliche Gesamtmodell und die aktuellen Einzelpfade stehen unter [docs/didactics/](didactics/README.md). Für alle Stufen gilt die [Darstellungsrichtlinie](representation-policy.md): Gesuchte Größen bleiben bis zur erfolgreichen Bearbeitung unbekannt.
