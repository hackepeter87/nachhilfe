...
**Korrigierter Umsetzungsstand 0.32.0:** Die Migrationen 0.22 bis 0.30 haben einen gemeinsamen technischen Vertrag hergestellt. Die manuelle Erprobung hat jedoch gezeigt, dass daraus nicht auf gleichwertige Verständlichkeit oder Förderqualität geschlossen werden darf. Der [kritische Audit 0.30.1](didactic-critical-audit-0.30.1.md) ersetzt diese frühere pauschale Bewertung. Version 0.31.0 ergänzt einen [reproduzierbaren didaktischen Prüfstand](didactic-review-workbench.md); 0.31.1 korrigiert konkrete iPhone-Befunde. Version 0.32.0 setzt die belegten Befunde und Lehrkraftbeispiele zu Stellenwert, Zahlbeziehungen, Zehnerübergang und Geld um. Neue Kompetenzen und der unabhängige Katalogkanal bleiben zurückgestellt, bis die bestehenden Familien manuell abgenommen sind.
