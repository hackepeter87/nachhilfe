...
Ein Git-Tag wie v0.20.0 erzeugt die Image-Tags 0.20.0, sha-<kurzsha> und latest. Eine manuelle Ausführung über workflow_dispatch erzeugt nur das nachvollziehbare SHA-Tag. Normale Pushes auf main veröffentlichen kein Image.
...
Der aktuell dokumentierte Stand ist das [GitHub Release v0.32.4](https://github.com/hackepeter87/nachhilfe/releases/tag/v0.32.4) mit dem Image `ghcr.io/hackepeter87/nachhilfe:0.32.4`. Deployment und Rollback verwenden weiterhin konkrete Image-Tags, nicht `latest`.
