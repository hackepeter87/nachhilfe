...
Nach Deployment ist die URL des konkreten Testsystems hier einzutragen. Lokal startet die App mit `npm run dev`; der Container mit `docker run --rm -p 8080:8080 mathe-reise:0.5.1`. Das öffentliche OCI-Image ist `ghcr.io/hackepeter87/nachhilfe:0.5.1`.
...
Aktiv sind Addition/Subtraktion bis 20, Einmaleins/Division, Stellenwert, Zerlegen/Zusammensetzen, Nachbarzehner/-hunderter, Runden, erste Rechenstrategien bis 1000, sieben Sachaufgabenbeziehungen und Raster-Symmetrie. Geld, Längen und Raumvorstellung sind vollständig vorbereitet, aber bewusst deaktiviert.
