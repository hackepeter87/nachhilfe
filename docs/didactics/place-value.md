...
Ziffer und Wert sowie die Funktion der Null als Platzhalter müssen sicher unterschieden werden.
## 2. Lehrplanbereich
Zahlen und Operationen; Darstellen, Argumentieren und Kommunizieren.
## 3. Konkretes Lernziel
Hunderter, Zehner und Einer einer Zahl bis 1000 bestimmen und ihren Wert erklären.
## 4. Voraussetzungen
Bündelung im Zehnersystem und Zahlen lesen.
## 5. Typische Fehlvorstellungen
Ziffer wird als Wert angegeben; Stellen werden vertauscht; Null wird ausgelassen.
