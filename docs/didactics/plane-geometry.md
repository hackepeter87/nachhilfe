...
## 12. Remediation
Nach Fehlern kehren Figuren zur einzelnen Grundform, Muster zum AB-Wechsel, Fläche zum kleinen vollen Rechteck und Umfang zum kurzen deutlich markierten Rechteckrand zurück. Die Variante bleibt verwandt, aber nicht identisch.
## 13. Transfer
Das Kind erklärt, warum eine gedrehte Figur dieselbe Form behält, beschreibt einen Musterblock oder begründet, warum gleiche Fläche nicht gleichen Umfang bedeutet.
## 14. Wiederholung
Unterkompetenzen trennen Erkennen, Zerlegen, Zusammensetzen, Musterblöcke, strukturierte und unregelmäßige Fläche sowie rechteckigen und unregelmäßigen Rand. Fläche und Umfang werden erst nach fünf Figurenversuchen und Lernwert 60 adaptiv ausgewählt.
## 15. Erfolgskriterien
Jede Aufgabe besitzt genau eine Lösung, Rasterfiguren sind zusammenhängend, alle Felder liegen im Raster, nur gefüllte Felder zählen zur Fläche und nur äußere Kanten zum Umfang.
## 16. Grenzen der aktuellen Umsetzung
Nicht enthalten sind Flächen- oder Umfangsformeln, Maßstab, freie Konstruktionen, Kreise als Messfiguren, komplex zusammengesetzte Umfänge oder nicht ganzzahlige Einheiten.
## 17. Punkte für die Gesamtprüfung
In Version 0.20 sind Begriffswahl, Unterscheidbarkeit von Fläche und Umfang, Erkennbarkeit der Teilungslinien und Bedienbarkeit auf einem echten iPhone extern zu prüfen. Eine Lehrkraftfreigabe oder Unterrichtserprobung liegt nicht vor.
