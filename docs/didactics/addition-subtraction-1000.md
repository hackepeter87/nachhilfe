...
Stellenweise und schrittweise Strategien sollen Übergänge vorbereiten, ohne sofort schriftliche Verfahren einzuführen.
## 2. Lehrplanbereich
Zahlen und Operationen; Problemlösen, Darstellen und Argumentieren.
## 3. Konkretes Lernziel
Einfache Additionen, Subtraktionen und Ergänzungen bis 1000 in sinnvolle Teilschritte zerlegen.
## 4. Voraussetzungen
Stellenwert, Zerlegen, Ergänzen zu vollen Zehnern/Hundertern und Grundaufgaben.
## 5. Typische Fehlvorstellungen
Stellen werden vermischt; Übergang wird ausgelassen; Rückwärtssprung hat falsche Richtung.
